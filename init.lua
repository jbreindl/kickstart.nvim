...
require('lazy').setup({
    ...
    { -- Fuzzy Finder (files, lsp, etc)
        ...
        config = function()
            require('telescope').setup {
                -- from https://github.com/nvim-telescope/telescope.nvim/issues/848, sets default value
        ...
        config = function()
            vim.api.nvim_create_autocmd('LspAttach', {
                ...
                callback = function(event)
                    ...
                    map('<leader>a', vim.lsp.buf.code_action, 'Goto Code [A]ction', { 'n', 'x' })
            ...
            --
            --  The user is responsible for installing the LSPs listed in this table.
            --
            ...
            -- The following loop will set up each of the servers that are configured above.
    ...
    { -- Highlight, edit, and navigate code
        ...
        opts = {
            ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'python', 'norg' },
